#ifndef __X86_ASSEMBLER_CODEGEN_ELF_HH__
#define __X86_ASSEMBLER_CODEGEN_ELF_HH__
...
struct ELFBuilder {
    ...
    auto build(const IRBuilder& ir_builder) -> void;
};

}  // namespace fiska::x86::codegen

#endif // __X86_ASSEMBLER_CODEGEN_ELF_HH__
